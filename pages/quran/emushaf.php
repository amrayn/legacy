...
$contents .= <<<PAGE
	...
	<div class='sequential' style='text-align:center;'>
		<a href='/$surah#$ayah' class='transition anchor-button'>Open in Web App</a>
    <a href='/quran/info/$surah' class='local anchor-button'>Surah Info</a>
    <a href='/memorization' class='local anchor-button'>Memorization Tracker</a>
    <a href='/revision' class='local anchor-button'>Revision Assistant</a>
	</div>
	<br/>
	<div style='text-align:center'>
