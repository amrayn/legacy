/*Changes made to this file by muflhun.com*/
  ...
  Player = function(playerNode) {
      ...
      var sound = soundManager.createSound({
        ...
        onfinish: function() {
          ...
          if (item && playlistController.data.selectedIndex !== lastIndex) {
			...
			if (typeof AudioMedia === "object" && typeof AudioMedia.onfinish === "function") {
				AudioMedia.onfinish();
			}
    ...
    actions = {
      ...
      playSelected: function() {
		if (typeof soundObject === "undefined" || !soundObject.playState) {
			actions.play(playlistController.data.selectedIndex);
		} else {
			soundObject.togglePause();
		}
      },
